...
**Cap clip duration at the source's native length.** Kling V3 Pro returns 5-, 10-, or 15-second clips. If you request a 5-second video and place it in a 9-second slot, the renderer will either freeze the last frame or produce artifacts. Check clip native duration before placing it. If the narration window is longer than the clip, generate a longer take or add a companion shot — don't overrun.
