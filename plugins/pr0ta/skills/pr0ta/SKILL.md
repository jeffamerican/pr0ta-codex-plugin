...
| **`pr0ta-video`** | Video model comparison, Seedance prompting guide with @tokens, global visual bible + storyboard chunk workflow, Kling prompting guide, multi-prompt, camera control, native audio, duration/aspect ratio per model | **Before generating video** |
